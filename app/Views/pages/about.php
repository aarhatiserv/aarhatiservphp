          ...
          <div class="container py-3">
            ...
            <div class="row">
              <div class="col-md-6">
                <img
                  class="img-fluid"
                  src="assets/images/brainstrom.png"
                  alt="bg image"
                />
              </div>
          ...
          <div class="container py-2">
            ...
            <div class="row">
              <div class="col-md-6">
                <img
                  class="img-fluid"
                  src="assets/images/creative_thinking.png"
                  alt="bg image"
                  width="75%"
                />
              </div>
          ...
          <div class="ourTeam my-5">
            <div class="container mt-5">
              ...
              <div class="row scrollingWrapper pl-4">
                  ...
                  <div class="card myTeamCard">
                    <div class="card-body">
                      <div class="row">
                        <div class="my-3">
                          <img
                            src="assets/images/team/prasenjeet_benarjeee.jpg"
                            alt="..."
                            class="img-fluid rounded-circle teamImg"
                          />
                        </div>
                ...
                <!--        <div class="my-3">-->
                <!--          <img-->
                <!--            src="assets/images/team/ahina.jpg"-->
                <!--            alt="..."-->
                <!--            class="img-fluid rounded-circle teamImg"-->
                <!--          />-->
                <!--        </div>-->
          ...
          <div class="container">
            <div class="row text-center">
              <div class="col-md-6 col-12">
                <img
                  class="img-fluid"
                  src="assets/images/udyog_certificate.png"
              ...
              <div class="col-md-6 col-12">
                <img
                  ...
                  src="assets/images/recogonition.png"
                  alt="Udyog certification"
                />
              </div>
            </div>
